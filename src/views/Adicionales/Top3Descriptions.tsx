...
function Top3Descriptions() {
  // Get all experiences from the data
  const experiencias = topAdicionalesData;

  if (!experiencias || experiencias.length === 0) {
    return (
      <div className='w-full panel relative snap-start h-dvh flex items-center justify-center'>
        <div className='text-center'>
          <h2 className='text-2xl font-bold text-gray-900 dark:text-white mb-4'>Contenido no disponible</h2>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      {experiencias.map((experiencia) => (
        <div key={experiencia.id} className='h-dvh relative snap-start snap-stop-always panel flex flex-col md:flex-row'>
      {/* Wrapper container for max-width on large screens */}
        ...
        <div className='md:hidden flex flex-row overflow-x-auto overflow-y-hidden space-x-3 flex-1'>
            ...
            <div className='bg-primary-500/40 backdrop-blur-md rounded-2xl p-5 min-w-[300px] sm:min-w-[350px]'>
                <h3 className='text-gray-800 dark:text-white text-xs font-semibold uppercase mb-2'>
                No incluye
                </h3>
                <ul className='text-sm text-gray-900 dark:text-white space-y-1'>
        ...
        {/* Description */}
        <div className='bg-primary-100/60 dark:bg-orange-900/30 backdrop-blur-md rounded-2xl p-5 md:py-2 md:px-4'>
        ...
        {/* Incluye */}
        <div className='bg-primary-200/60 dark:bg-orange-900/30 backdrop-blur-md rounded-2xl p-5 md:py-2 md:px-4'>
            <h3 className='text-black dark:text-white text-xs font-bold uppercase mb-3 tracking-wider'>
            Incluye
            </h3>
        ...
        {/* Requisitos */}
        <div className='bg-primary-300/60 dark:bg-orange-900/30 backdrop-blur-md rounded-2xl p-5 md:py-2 md:px-4'>
            <h3 className='text-black dark:text-white text-xs font-bold uppercase mb-3 tracking-wider'>
            Requisitos
            </h3>
            <ul className='text-sm text-gray-900 dark:text-white space-y-2'>
        ...
        {/* No incluye */}
        <div className='bg-primary-400/60 dark:bg-orange-900/30 backdrop-blur-md rounded-2xl p-5 md:py-2 md:px-4'>
            <h3 className='text-black dark:text-white text-xs font-bold uppercase mb-3 tracking-wider'>
            No incluye
            </h3>
            <ul className='text-sm text-gray-900 dark:text-white space-y-2'>
...
export default Top3Descriptions;