...
const ExperienciasCarousel = ({ 
  ...
  navigationClass = "swiper-button-carousel"
    ...
    return (
            <div className="flex-1 container-content py-6 sm:py-8 md:py-0 z-20 flex flex-col relative md:mt-0 md:w-full">
                ...
                <div className='flex-1 flex flex-col justify-start relative z-20 md:pt-2'>
                    <div className="flex flex-row items-center justify-center lg:justify-end gap-4 lg:pr-20 lg:gap-2">
                    ...
                    <div className='relative flex justify-center'>
                        ...
                        {isMounted && (
                            <Swiper className='w-full xs:max-w-[700px] md:max-w-[800px] xl:max-w-[850px] min-h-[60dvh] xs:min-h-[62dvh] md:min-h-[48dvh] px-4 relative'
