      ...
      <div className="panel">
        ...
        <section className="h-[100dvh] relative snap-start xl:hidden">
          <div className="relative w-full h-full overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center justify-around h-full gap-4 sm:grid sm:grid-flow-row sm:row-span-1 sm:col-span-3 sm:grid-rows-8 sm:grid-cols-8 lg:grid-rows-9 lg:grid-cols-10">
              {/* Title block*/}
              ...
              <div className="w-full px-4 flex items-center justify-center sm:px-0 sm:row-start-7 sm:col-start-6 sm:justify-end md:row-start-7 md:col-start-7 lg:col-start-9 lg:row-start-8 lg:items-end">
