...
const About = () => {
    ...
    return (
        <>
            <section className="panel h-screen relative snap-start backdrop-blur-3xl">

                {/* <div className='shape absolute w-full h-[60vh] left-0 right-0 rotate-180'></div> */}
                <div className="relative z-20 h-full w-full backdrop-blur-3xl flex flex-col justify-start px-6 lg:p-28 xl:p-40 ">
                    ...
                    <section className="z-20">
                        ...
                        <div className='relative w-full mt-4'>
                            ...
                            <div className='absolute inset-0 z-10 backdrop-blur-2xl rounded-3xl' />
                        </div>
                    </section>
                </div>
